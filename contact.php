			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="navbars-rs-food">
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item"><a class="active" href="contact.php">Contact</a></li>&nbsp;&nbsp;
...
if(isset($_REQUEST['sub']))
{
	...
	if($email==$run['email'])
	{
		mysql_query("INSERT INTO feedback VALUES('$name','$email','$phone','$mesg')");
		echo "<script>location.href='contactss.php?name=$name'</script>";
	}
	else 
	{
		?>
		<marquee class="marquee-php">"Email does not match!! Please Register"</marquee>
<?php		
	}
}
?>
		  ...
		  <div class="container">
			<div class="row justify-content-center">
				<div class="col-md-6 text-center mb-5">
					...
					<p>You can contant us through this form about what you want to say.</p>
				</div>
			</div>
			<div class="row justify-content-center">
				<div class="col-md-12">
										...
										<div class="row">
											...
											<div class="col-md-6">
												<div class="form-group">
													...
													<input type="text" class="form-control" name="t3"  placeholder="Phone Number" required>
												</div>
											...
											<div class="col-md-12">
												<div class="form-group">
													...
													<input type="email" class="form-control" name="t2" id="email" placeholder="Email" required>
												</div>
											</div>
											<div class="col-md-12">
												<div class="form-group">
													<label class="label" for="#">Message</label>
													<textarea name="t4" class="form-control" id="message" cols="30" rows="4" placeholder="Message" required></textarea>
												</div>
											</div>
											<div class="col-md-12">
												<div class="hvr-curl-bottom-right send-msg">
