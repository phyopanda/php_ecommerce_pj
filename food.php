...
<body>
			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="navbars-rs-food">
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item"><a class="active" href="food.php">Menu</a></li>&nbsp;&nbsp;			
	...
	<div class="menu-box">
			...
			<div class="row">
				<div class="col-lg-12">
					...
					<div class="btn-custom">
						<a href="food.php"><button type="button" class="btn btn-outline-primary"><img class="menu-logo" src="images/hot-pot.png">All</button></a>
						<?php getBrands(); ?>
					</div>
				</div>
			</div>
		...
		<div class="row inner-menu-box btn-group btn-group-lg">
