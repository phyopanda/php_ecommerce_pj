...
<body>
	...
	<div class="all-page-title page-breadcrumb">
		<div class="container text-center">
			<div class="row">
				<div class="col-lg-12">
					<h1>Your Register is successfully</h1>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="container">
			...
			<div class="row">
				<div class="col">
					...
					<h2>Your Email is: <?php echo "<font color=maroon size=4><i>".@$_REQUEST['wel']."</i></font>";?></h2>
					<h2>Your Password is: <?php echo "<font color=maroon size=4><i>".@$_REQUEST['pass']."</i></font>";?></h2>
					<h2>Enjoy your order!</h2>
					<h2>Thank you.</h2>
					<a class="btn btn-lg btn-circle btn-outline-new-white hvr-hang" href="?log=out">Go back</a>
				</div>
				<div class="col">
					<img src="images/welcome.webp"></img>
					<img src="images/welcome2.webp"></img>
				</div>
			</div>
		</div>
	</div>
