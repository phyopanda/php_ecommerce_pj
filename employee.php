					...
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item dropdown">
							...
							<div class="dropdown-menu" aria-labelledby="dropdown-a">
								<a class="dropdown-item hvr-radial-in1" href="employee.php"><img class="menu-logo" src="images/employee.png">Employee</a>		
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="heading-title text-center">
						<h2>The best people in each position</h2>
			...
			<div class="row">
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="our-team">
                        ...
                        <div class="team-content">
                            ...
                            <span class="post">Restaurant Manager</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="our-team">
                        ...
                        <div class="team-content">
                            <h3 class="title">Stiana Ki</h3>
                            <span class="post">Delivery</span>
                        </div>
                    </div>
                </div>
