			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="navbars-rs-food">
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item"><a class="active" href="feedback.php">Feedback</a></li>&nbsp;&nbsp;
		...
		<div class="container">
			...
			<center>
			 <?php
				...
				while(list($p_id, $p_brands, $p_model, $p_price, $p_modele, $p_pricee, $p_p, $p_m, $p_pr, $p_pri) = mysqli_fetch_array($result))
				{
