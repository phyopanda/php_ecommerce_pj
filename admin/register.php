			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="navbars-rs-food">
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item"><a class="active" href="register.php">Register</a></li>&nbsp;&nbsp;
		...
		<div class="container">
			...
			<center>
			 <?php
				...
				while(list($p_id, $p_brands, $p_model, $p_price, $p_modele, $p_pricee, $p_p, $p_m, $p_pr, $p_pri, $p_prio) = mysqli_fetch_array($result))
				{
					...
					echo "<td>". $p_pri ."</td>";
					echo "<td>". $p_prio ."</td>";
					echo "<td>"."<a href='delete3.php?pro_id=$p_id'>Delete</a>"."</td>";
				    echo "</tr>";
				}
				echo "</table>";
		  ?>
