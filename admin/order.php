			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="navbars-rs-food">
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item"><a class="active" href="order.php">Orders</a></li>&nbsp;&nbsp;
		...
		<div class="container">
			...
			<center>
			 <?php
				...
				while(list($p_id, $p_brands, $p_model, $p_price, $p_modele, $p_pricee, $p_p, $p_m) = mysqli_fetch_array($result))
				{
					...
					echo "<td>"."<a href='delete2.php?pro_id=$p_id'>Delete</a>"."</td>";
				    echo "</tr>";
				}
				echo "</table>";
		  ?>
