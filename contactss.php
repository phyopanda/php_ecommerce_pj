...
<body>
	...
	<div class="all-page-title page-breadcrumb">
		<div class="container text-center">
			<div class="row">
				<div class="col-lg-12">
					<h1>Thankyou-&#10084;-<?php echo "<font color=maroon>".@$_REQUEST['name']."</font>"; ?></h1>
				</div>
			</div>
		</div>
	</div>
		  ...
		  <div class="container">
			<div class="row justify-content-center">
				<div class="col-md-6 text-center mb-5">
					 <h2 class="heading-section">Your Feedback has been sent seccessfully &#10003;&#10003;</h2>
			...
			<div class="col">
					<a class="btn btn-lg btn-circle btn-outline-new-white hvr-hang" href="index.php">Go back</a>
			</div>
		</div>
	</section>
		</div>
